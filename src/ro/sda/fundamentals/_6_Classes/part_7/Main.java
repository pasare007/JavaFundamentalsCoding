...
public class Main {
    public static void main(String[] args) {
        ...
        Floor floor = new Floor(5.3, 7.5);Calculator calculator = new Calculator(floor, carpet);
        ...
        System.out.println("The cost for onother floor carpeting is: "+ calculator.getTotalCost());
